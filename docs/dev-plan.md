...
| 7 | 외부 통합 전략 — 팝빌+CODEF 하이브리드 (조회/수집=CODEF 점진 도입) | 진행중 | 2026-05~07 |
| 8 | 영업관리 V1 — 처음 사업 시작하는 사장님용 가이드 (휴게음식점 38항목) | 완료 | 2026-04-25 |
| 9 | CODEF Phase 1 — 백엔드/프론트 풀 구현 + prod 배포 (PoC 미완, 매출 채널은 이지포스로 재평가) | 코드완료/PoC진행 | 2026-04-29 |
| 10 | 이지포스(KICC) VAN사 API 통합 — 카드 매출 자동수집 (셈하나 매출 채널 정답) | 시작 (KICC API 키 대기) | 2026-05 |
