...
import api from '../api';
import { LayoutDashboard, Receipt, Settings, Users, UserCircle, LogOut, ShoppingBag, FileSignature, CreditCard, BarChart3, BookOpen, Menu, X, Smartphone, Home, ClipboardList, Rocket, Monitor, ChevronDown, ChevronUp, Package, Shield, Building2, FileText, Bell, TrendingUp, Wallet, ArrowLeftRight, Truck, PieChart, Palette, Store, Brain, Globe } from 'lucide-react';
...
export default function Sidebar() {
    ...
    useEffect(() => {
        ...
        const hrPaths = ['/employees', '/hr/retirement', '/hr/foreign-worker-guide'];
    ...
    const isHrActive = ['/employees', '/hr/retirement', '/hr/foreign-worker-guide'].some(p => location.pathname === p || (p !== '/employees' && location.pathname.startsWith(p)));
