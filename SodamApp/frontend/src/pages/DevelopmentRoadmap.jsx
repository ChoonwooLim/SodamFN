...
const phases = [
    ...
    },
    {
        ...
        icon: Globe,
        description: '소담FN을 다른 소규모 사업자들도 사용할 수 있는 SaaS 플랫폼으로 확장합니다.',
        modules: [
            {
                name: '멀티테넌트 아키텍처',
                status: 'planned',
