        ...
        modules: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: '정식 재무제표 3종 — 손익(영업/순이익 분리)·현금흐름표(통장 1원 대조)·재무상태표 + 자산대장·감가상각', done: true },
                    { text: '인건비·세금 실납부 기준 정합 (실송금·4대보험·원천세) + 카드수수료 실효요율 자동 산정', done: true },
                ],
            },
            {
                name: '배달앱 매출 관리',
            ...
            },
            {
                ...
                status: 'done',
                items: [
                    { text: '신규 사장님용 사업 시작 가이드 (38 항목 6 카테고리)', done: true },
                    { text: '인허가·신고 (사업자등록·영업신고·위생교육·보건증·화재배상 등 7 항목)', done: true },
                    { text: '배달·온라인 채널 가입 가이드 (배민/쿠팡/요기요/네이버/카카오 등 8 항목)', done: true },
                    { text: '결제·POS 설정 (단말기·현금영수증·POS·간편결제 5 항목)', done: true },
                    { text: '세무·회계 일정 추적 (부가세/종소세/원천세/4대보험 등 6 항목)', done: true },
                    { text: '인력·노무 가이드 (근로계약·4대보험·최저임금·외국인고용·퇴직금 5 항목)', done: true },
                    { text: '항목별 체크리스트 + 발급일/만료일 기록 (L3 인터랙션)', done: true },
                    { text: 'HR/세무 모듈 자동 카운트 동기화 (보건증·4대보험·근로계약 등 4종)', done: true },
                    { text: 'business_docs 통합 (사업자등록증·영업신고증 등 5종 직접 업로드)', done: true },
                    { text: '사이드바 빨간 배지 (미완료 + 만료임박 카운트)', done: true },
                    { text: '운영팁 7 골격 (콘텐츠 점진 작성 — V2.3)', done: true },
                ],
            },
            {
                name: '자재·구매 관리 시스템 (2026-07-23)',
                status: 'done',
                items: [
                    { text: '구매요청서 작성/관리 — 거래처별 품목 체크·단위(개/box/kg/g)·통합요청서 PDF·카톡 전송', done: true },
                    { text: '주거래처 메뉴 + 주거래처·품목 관리 (과세 자동분류·단가 이력·제품 사진)', done: true },
                    { text: '영수증 보관함 — 촬영→AI 자동분류(gemma4)→매입 반영, 카드/이체 중복 차단', done: true },
                    { text: '직원 앱 구매요청 통합 (같은 양식, 작성자 표기, 관리 이력 합류)', done: true },
                    { text: '재고관리 (안전재고 미달→요청서 원클릭) + 날짜별 보관/관리 뷰', done: true },
                    { text: '모바일 전면 최적화 — 바텀내비 중앙 영수증 촬영 버튼, 40여건 레이아웃 수정', done: true },
                ],
            },
        ],
    },
        ...
        modules: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: '팝빌 전자세금계산서 발행 (TaxinvoiceService) — 운영 풀세트(잔액·샘플·뷰어·인쇄·PDF·이메일·취소) 4/29 완료', done: true },
                    { text: '팝빌 전자명세서 발행 (StatementService) — 6종 양식(거래명세서·청구서·견적서·발주서·입금표·영수증) 4/29 완료', done: true },
