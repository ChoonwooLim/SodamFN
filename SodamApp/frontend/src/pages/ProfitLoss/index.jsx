...
const EXPENSE_FIELDS = [
    ...
    { key: 'expense_insurance', label: '4대보험료(납부총액)', auto: true, group: 'expense-labor' },
    { key: 'expense_tax_employee', label: '원천세(납부)', auto: true, group: 'expense-labor' },
            ...
            <div className={`${wideTab ? 'max-w-screen-2xl' : 'max-w-6xl'} mx-auto px-6 pt-8 pb-32`}>
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center gap-3 bg-slate-100 px-4 py-2 rounded-xl">
                        <button onClick={() => setYear(y => y - 1)} className="w-10 h-10 rounded-lg bg-slate-200 hover:bg-slate-300 text-slate-600 border-none cursor-pointer text-sm transition-colors flex items-center justify-center">◀</button>
