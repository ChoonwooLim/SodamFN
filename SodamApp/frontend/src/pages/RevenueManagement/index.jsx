                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    {(viewMode === 'revenueDetail' || viewMode === 'deliveryApp') ? (
                        <div className="flex items-center gap-3 bg-slate-100 px-4 py-2 rounded-xl">
                            <button onClick={() => setPlYear(y => y - 1)} className="w-10 h-10 rounded-lg bg-slate-200 hover:bg-slate-300 text-slate-600 border-none cursor-pointer flex items-center justify-center transition-colors"><ChevronLeft size={16} /></button>
