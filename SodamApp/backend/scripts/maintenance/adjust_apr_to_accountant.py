...
TAX_ACCOUNTANT_APR = {
    '김금순':  (142500, 131040, 0,     17170, 114990, 11490),  # 4대보험 + 세금대납
    '정명주':  (13300,  111220, 17920, 14530, 12220,  1220),   # 4대보험
    '정수현':  (17740,  67140,  3370,  8820,  37650,  3760),   # 4대보험
    '김순복':  (0,      60260,  3020,  7910,  17390,  1730),   # 4대보험 (NP 미가입)
    '김다은':  (0,      0,      11440, 0,     0,      0),      # 일용직 EI만 (PDF 일치)
    '정수미':  (0,      0,      0,     0,     55900,  5590),   # 3.3% 사업소득
    '반정옥':  (0,      0,      0,     0,     19800,  1980),   # 3.3% 사업소득 (퇴사 정산완료)
    '황윤선':  (0,      0,      0,     0,     42200,  4220),   # 3.3% 사업소득
    '고아라':  (0,      0,      0,     0,     5940,   590),    # 3.3% 사업소득
    '린':      (0,      0,      1580,  0,     0,      0),      # 일용직 EI 추정 (PDF 별도 확인 권장)
}
